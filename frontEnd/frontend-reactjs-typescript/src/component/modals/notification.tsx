...
const ModalNotification =()=> {
  ...
  return (
    <div className={`z-[100] fixed w-[300px] min-h-[150px] bg-white rounded-xl shadow-xl duration-500 transition-all ease-in-out ${!display ? '-top-[500px]' : 'top-[40px]'}  translate-x-1/2`}>
